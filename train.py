...
libtiff.libtiff_ctypes.warning_handler = custom_warning_handler

dir_img = 'data\\train_images'
dir_mask = 'data\\train_masks'
...
def train_net(net,
    ...
    dataset = BasicDataset(dir_img, dir_mask, img_scale, tif=True)
        ...
        with tqdm(total=n_train, desc=f'Epoch {epoch + 1}/{epochs}', unit='img') as pbar:
            for batch in train_loader:
                ...
                assert imgs.shape[1] == net.n_channels, \
                    ...
                    f'but loaded images have {imgs.shape[1]} channels and {imgs.shape}. Please check that ' \
